...
} from "./image-canvas.trainer.interfaces"

interface IShapeFieldItem {
  shape: IImageCanvasTrainerShape
  x: number
  y: number
}
...
@Component({
  selector: "trainer-image-canvas",
  templateUrl: "./image-canvas.trainer.component.html",
  styleUrls: [ "./image-canvas.trainer.component.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ImageCanvasTrainerComponent implements OnInit, OnChanges {
  ...
  result: IImageCanvasTrainerResult = {
    id: "image-canvas",
    config: this.config
  }

  @Output("result")
  resultValueChange = new EventEmitter<IImageCanvasTrainerResult>()

  private _updateResult(result: Partial<IImageCanvasTrainerResult>) {
