...
import { IMatrixSequencePlayTrainerConfig } from "./matrix-sequence-play.trainer.interfaces"
...
@Component({
  ...
  templateUrl: "./matrix-sequence-play.trainer.component.html",
  styleUrls: [ "./matrix-sequence-play.trainer.component.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MatrixSequencePlayTrainerComponent
  extends AbstractTrainerComponent<IMatrixSequencePlayTrainerConfig> {
