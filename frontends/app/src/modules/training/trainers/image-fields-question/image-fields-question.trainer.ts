...
import { IImageFieldsQuestionConfig } from "./image-fields-question.interfaces"

const ASSETS_ICONS = "/assets/icons"

@Component({
  selector: "trainer-image-fields-question",
  templateUrl: "./image-fields-question.trainer.html",
  styleUrls: [ "./image-fields-question.trainer.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ImageFieldsQuestionTrainer extends AbstractTrainer<IImageFieldsQuestionConfig> {
