...
import { genSVGRectangle } from "../../libs/svg"

import { AbstractTrainer } from "../abstract"
import { IImageCarpetsConfig } from "./image-carpets.interfaces"
...
@Component({
  ...
  templateUrl: "./image-carpets.trainer.html",
  styleUrls: [ "./image-carpets.trainer.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ImageCarpetsTrainer extends AbstractTrainer<IImageCarpetsConfig> {
