...
import { IClassificationDefinitionsConfig } from "./classification-definitions.interfaces"
...
@Component({
  ...
  templateUrl: "./classification-definitions.trainer.html",
  styleUrls: [ "./classification-definitions.trainer.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ClassificationDefinitionsTrainer extends AbstractTrainer<IClassificationDefinitionsConfig> {
