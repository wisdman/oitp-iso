...
import { IPointerEvent } from "../../libs/pointer-events"

import { AbstractTrainer } from "../abstract"
import { IMatrixImagesFillingConfig } from "./matrix-images-filling.interfaces"

const ASSETS_ICONS = "/assets/icons"

@Component({
  selector: "trainer-matrix-images-filling",
  templateUrl: "./matrix-images-filling.trainer.html",
  styleUrls: [ "./matrix-images-filling.trainer.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MatrixImagesFillingTrainer extends AbstractTrainer<IMatrixImagesFillingConfig> {
