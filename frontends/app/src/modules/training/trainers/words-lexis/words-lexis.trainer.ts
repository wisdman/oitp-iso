...
import { genSVGEllipse, genSVGLine, genSVGRectangle, SVGShape } from "../../libs/svg"
import { textSize } from "../../libs/text-size"

import { AbstractTrainer } from "../abstract"
import { IWordsLexisConfig } from "./words-lexis.interfaces"
