...
import { IMatrixSequenceFillingConfig } from "./matrix-sequence-filling.interfaces"
...
@Component({
  ...
  templateUrl: "./matrix-sequence-filling.trainer.html",
  styleUrls: [ "./matrix-sequence-filling.trainer.css" ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MatrixSequenceFillingTrainer extends AbstractTrainer<IMatrixSequenceFillingConfig> {
