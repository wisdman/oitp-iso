...
CREATE UNIQUE INDEX words_questions_close_data__unique_idx__word
  ON trainer.words_questions_close_data USING btree ("word") WHERE "deleted" IS NULL;

CREATE INDEX words_questions_close_data__idx__enabled_deleted
  ON trainer.words_questions_close_data USING btree ("enabled", "deleted");
