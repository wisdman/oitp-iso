INSERT INTO private.complexity_defaults("trainer", "complexity", "previewTimeLimit", "playTimeLimit") VALUES
  ('classification-colors'      , 1,     0,  60000), -- Активизация лексиклна - цвета
  ('classification-definitions' , 1,     0,  60000), -- Активизация лексиклна - дифиниции
  ('classification-words'       , 1,     0,  90000), -- Активизация лексиклна - слова по группам
  ...
  ('text-letters'               , 1, 10000,  30000), -- Точность восприятия - афоризмы
  ('text-reading'               , 1,     0,  30000), -- Точность восприятия - тексты
  ('text-tezirovanie'           , 1,     0,  60000), -- Тезирование
  ('words-column'               , 1, 10000, 120000), -- Мнемотехника - столбики
  ('words-filling'              , 1,     0,  60000), -- Вариативность мышления - существительные
  ('words-lexis-antonyms'       , 1,     0,  40000), -- Вербальный интеллект - антонимы
  ('words-lexis-paronyms'       , 1,     0,  40000), -- Вербальный интеллект - паронимы
  ('words-lexis-synonyms'       , 1,     0,  40000), -- Вербальный интеллект - синонимы
  ('words-pairs'                , 1, 10000,  60000), -- Точность восприятия - пары слов
