...
CREATE TABLE trash.matrix_filling_pattern_data() INHERITS (trainer.matrix_filling_pattern_data, private.trash);
...
CREATE INDEX matrix_filling_pattern_data__idx__enabled
