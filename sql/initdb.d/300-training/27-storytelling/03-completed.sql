...
CREATE TABLE trainer.storytelling_users_completed (
  ...
  CONSTRAINT trainer__storytelling_users_completed__pkey PRIMARY KEY ("id", "owner"),

  CONSTRAINT trainer__storytelling_users_completed__fkey__id FOREIGN KEY ("id")
    REFERENCES trainer.storytelling_data("id")
    ON UPDATE CASCADE ON DELETE CASCADE,

  CONSTRAINT trainer__storytelling_users_completed__fkey__owner FOREIGN KEY ("owner")
