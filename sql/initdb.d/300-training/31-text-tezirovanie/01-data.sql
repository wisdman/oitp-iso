...
CREATE TABLE trash.text_tezirovanie_data() INHERITS (trainer.text_tezirovanie_data, private.trash);
...
CREATE INDEX text_tezirovanie_data__idx__enabled
  ON trainer.text_tezirovanie_data USING btree ("enabled");
