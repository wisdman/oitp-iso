...
CREATE UNIQUE INDEX words_pairs_data__unique_idx__wordA_wordB
  ON trainer.words_pairs_data USING btree ("wordA", "wordB") WHERE "deleted" IS NULL;

CREATE INDEX words_pairs_data__idx__enabled_deleted
  ON trainer.words_pairs_data USING btree ("enabled", "deleted");
